...
|autoComplectList|String|false|array: true<br>minsize: 1<br>maxsize: 100<br>maxlength: 50|Allows an app to prepopulate the text field with a list of suggested or completed entry as the user types|
